...
import com.groupware.bookcatalogadmin.controller.ActivityRegisterElementController;
...
public class RegisterElementActivity extends ActionBarActivity {

	private final static String TAG = RegisterElementActivity.class.getSimpleName();
	
	private ActivityRegisterElementController controller;
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    actionBar.setTitle("Registrar nuevo material");
	...
	protected void onStart() {
		super.onStart();
		Log.i(TAG, "onStart");
		controller = new ActivityRegisterElementController(this);
	}
	...
	*/
	...
	public ActivityRegisterElementController getController() {
		return controller;
	}
